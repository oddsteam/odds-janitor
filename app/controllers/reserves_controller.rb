class ReservesController < ApplicationController
  ...
  def index
    ...
    @rooms = [
      { id: 1, name: "Meeting 1", address: "Binary Base", seat: 3, description: "Small meeting room", maxSeat: 3, x: 1270, y: 767.5, width: 200, height: 125 },
      { id: 2, name: "Meeting 2", address: "Binary Base", seat: 6, description: "Medium meeting room", x: 548.9, y: 757, width: 185.5, height: 149 },
      { id: 3, name: "Territory 1", address: "Binary Base", seat: 5, description: "Large meeting room", x: 169, y: 734.5, width: 184.7, height: 164 },
      { id: 4, name: "Territory 2", address: "Binary Base", seat: 5, description: "Extra large meeting room", x: 169, y: 554.5, width: 184.7, height: 164.5 },
      { id: 5, name: "Territory 3", address: "Binary Base", seat: 5, description: "Extra large meeting room", x: 93.5, y: 352.5, width: 260, height: 186.5 },
      { id: 6, name: "Global", address: "Binary Base", seat: 30, description: "Extra large meeting room", x: 93.5, y: 55.5, width: 669.5, height: 281 },
      { id: 7, name: "All Nighter 1", address: "Binary Base", seat: 36, description: "LeSSex Area", x: 1805, y: 418.05, width: 570, height: 500 },
      { id: 8, name: "All Nighter 2", address: "Binary Base", seat: 32, description: "LeSSex Area", x: 1805, y: 54, width: 675, height: 406.5 },
    ]

    @selected_room = params[:selected_room] || set_default_room
    @selected_index = @rooms.find_index { |room| room[:name] == @selected_room }
    @selected_room_id = @rooms.find { |room| room[:name] == @selected_room }&.dig(:id)
  end
